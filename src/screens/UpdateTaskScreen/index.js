...
//		Components
//-----------------------------------------------------------------------------
const UpdateTaskScreen = ({ route, refresh }) => {

  const task = buildTaskFromRoute(route);
  
  const [name, setName] = useState(task.name);
  const [course, setCourse] = useState(task.course.id);
  const [showModal, setShowModal] = useState(false);
  const [courseName, setCourseName] = useState(task.course.name);
  ...
  const color = useRef(task.course.color);
...
//		Functions
//-----------------------------------------------------------------------------
function buildTaskFromRoute(route) {
  return {
    id: route.params.id,
    ...
    course: {
      ...
      color: route.params.courseColor
    },
